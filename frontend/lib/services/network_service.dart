...
class NetworkService {
  ...
  2. 은행 보안 관련 어플은 인증 절차와 같은 사용기간에는 wi-fi 사용 못하게 해야할 경우가 있음
  ...
  // 현재 연결 타입 가져오기
  // _connectivity = network_service.dart 에서만 사용가능한 변수명칭
